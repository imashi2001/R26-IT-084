 ...
 * @param {Buffer|null} payload.imageBuffer
 * @param {string|null} payload.imageMimetype
 * @param {string|null} payload.fillLevel
 * @param {number|null} payload.userId
 * @param {number|null} payload.deviceId
 * @param {string|null} payload.bridgeInstanceId
 * @param {Array<{label:string, confidence:number, box:number[]}>} payload.predictions
 * @param {object|null} payload.extras   -- extra Capture columns (waste/animal/risk/weather)

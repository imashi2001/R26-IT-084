/** Shared dark-theme UI tokens for all dashboard pages. */
...
export const chipClass =
  "inline-flex items-center rounded-lg border border-slate-700/60 bg-slate-900/50 px-2.5 py-1 text-xs font-medium text-slate-300";

export const chipActiveClass =
  "inline-flex items-center rounded-lg border border-brand-500/40 bg-brand-500/15 px-2.5 py-1 text-xs font-semibold text-brand-400";
